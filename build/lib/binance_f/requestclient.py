...
class RequestClient(object):
    ...
    def get_download_id(self,symbol:'str',startTime:'str',endTime:'str',dataType:"str"):
        response = call_sync(self.request_impl.download_id(symbol,startTime,endTime,dataType))
        self.refresh_limits(response[1])
        return response[0]
